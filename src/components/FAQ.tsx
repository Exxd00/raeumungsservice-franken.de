...
const faqs = [
  ...
  {
    question: "Was bedeutet \u201esmart entrümpeln\u201c bei Ihnen?",
    answer:
      "Smart entrümpeln heißt für uns: ein durchdachter, digitaler Prozess statt Chaos. Sie erhalten nach Fotos oder einem kurzen Video eine schnelle Ersteinschätzung, verwertbare Möbel und Wertgegenstände werden erkannt und angerechnet, und ein Großteil des Hausrats wird wiederverwendet, gespendet oder recycelt statt weggeworfen. So sparen Sie Zeit und Geld – und schonen die Umwelt.",
  },
  {
    question: "Bieten Sie auch Umzüge an?",
    answer:
      "Ja! Wir übernehmen Ihren kompletten Umzug – von der Planung über professionelles Ein- und Auspacken bis zur Möbelmontage am neuen Wohnort. Besonders beliebt ist unsere Smart-Kombi: Wir ziehen Sie um und entrümpeln parallel die alte Immobilie besenrein – ein Ansprechpartner, ein Termin, ein Festpreis.",
  },
  {

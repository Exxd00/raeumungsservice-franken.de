...
export const services: Service[] = [
  ...
  },
  {
    name: "Umzug",
    slug: "umzug",
    shortDescription: "Stressfreier Umzug mit Rundum-Service – oft kombiniert mit Entrümpelung",
    description: "Ob Wohnungswechsel, Firmenumzug oder Seniorenumzug – wir organisieren Ihren kompletten Umzug von A bis Z. Von der Planung über professionelles Verpacken und den sicheren Transport bis zum Möbelaufbau am neuen Wohnort. Das Besondere: Auf Wunsch kombinieren wir Ihren Umzug direkt mit der Entrümpelung der alten Immobilie – alles aus einer Hand, ein Ansprechpartner, ein Termin.",
    icon: "package",
    features: [
      "Komplette Umzugsplanung & Beratung",
      "Professionelles Ein- und Auspacken",
      "Möbelmontage & -demontage",
      "Sicherer Transport mit eigenem Team",
      "Smart kombinierbar mit Entrümpelung"
    ],
    keywords: ["Umzug Nürnberg", "Umzugsservice Franken", "Umzugsunternehmen Nürnberg", "Möbeltransport", "Firmenumzug", "Privatumzug", "Umzug mit Entrümpelung"]
  },
  {
